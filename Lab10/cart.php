...
<body>
    ...
    <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <h3>Total Price: <?= $total_price ?> VNĐ</h3>
        <?php $_SESSION['total_price'] = $total_price ?>
        <input type="submit" name="delete_submit" value="Remove from Your Cart">
    </form>
    <br>
    ...
    <form action="checkout.php" method="GET">
        <input type="submit" name="checkout_submit" value="Check Out">
    </form>
</body>
</html>